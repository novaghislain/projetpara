...
<head>
  <meta charset="UTF-8">
  <title>GEL RH — Inscription Autonome</title>
...
<div class="auth-container">
  ...
  <div class="auth-body">
    <form action="{{ route('gel-rh.register.autonomous.submit') }}" method="POST">
      @csrf
      ...
      <div class="text-center mt-3" style="font-size: 13px;">
        <a href="{{ route('gel-rh.register.choices') }}" style="color: #6B7280; text-decoration: none;"><i class="fas fa-arrow-left"></i> Retour au choix</a>
      </div>
