...
<head>
    ...
    <title>Administration | GEL Cabinet</title>
    <meta name="description" content="Service Administration GEL Cabinet : utilisateurs, rôles, permissions, sécurité, audit, journalisation et paramètres avancés.">
    ...
    <style>
        :root {
            ...
            --gel-svc: #6B7280; --gel-svc-rgb: 107,114,128;
...
@include('partials.navbar')
    <div class="gel-page-header">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="gel-page-header-badge"><i class="bi-shield-lock"></i> Service</div>
                    <h1>Administration</h1>
                    <p>Gérez les utilisateurs, les rôles et permissions, la sécurité des accès, l'audit des activités et le paramétrage avancé de votre plateforme.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="col-lg-7 text-center">
                    <h2 class="gel-section-title anim-fade-up">Contrôle total de votre plateforme</h2>
                    <p class="gel-section-sub mx-auto anim-fade-up delay-1">Des outils d'administration puissants pour sécuriser et piloter votre environnement de travail.</p>
                </div>
            </div>
            <div class="row g-4">
                <div class="col-md-4 anim-fade-up delay-1">
                    <div class="gel-feature-card">
                        <div class="gel-feature-icon"><i class="bi-people-fill"></i></div>
                        <h5>Gestion des utilisateurs</h5>
                        <p>Création, modification et désactivation des comptes. Profils personnalisés avec informations détaillées.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-2">
                    <div class="gel-feature-card">
                        ...
                        <p>10 profils prédéfinis (Directeur, Comptable, Secrétaire, Caissier...) avec permissions granulaires par module.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-3">
                    <div class="gel-feature-card">
                        ...
                        <h5>Sécurité & 2FA</h5>
                        <p>Authentification à deux facteurs, gestion des sessions actives, politique de mots de passe et verrouillage.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-1">
                    <div class="gel-feature-card">
                        ...
                        <p>Traçabilité complète de toutes les actions : connexions, modifications, suppressions avec horodatage et utilisateur.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-2">
                    <div class="gel-feature-card">
                        <div class="gel-feature-icon"><i class="bi-key"></i></div>
                        <h5>Licences & Abonnements</h5>
                        <p>Gestion des licences, activation des modules, suivi des abonnements et périodes d'essai.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-3">
                    <div class="gel-feature-card">
                        <div class="gel-feature-icon"><i class="bi-gear"></i></div>
                        <h5>Paramètres avancés</h5>
                        <p>Configuration globale, personnalisation de l'interface, préférences système et intégrations.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="col-lg-7 text-center">
                    ...
                    <p class="gel-section-sub mx-auto anim-fade-up delay-1">Une administration centralisée et sécurisée.</p>
                </div>
            </div>
            <div class="row g-4 justify-content-center">
                <div class="col-md-4 anim-fade-up delay-1">
                    <div class="gel-process-step">
                        ...
                        <h5>Configuration</h5>
                        <p>Paramétrez votre plateforme, créez les comptes utilisateurs et définissez les rôles et permissions.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-2">
                    <div class="gel-process-step">
                        ...
                        <h5>Sécurisation</h5>
                        <p>Activez la 2FA, configurez les politiques de sécurité et vérifiez les journaux d'audit régulièrement.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-3">
                    <div class="gel-process-step">
                        ...
                        <h5>Pilotage</h5>
                        <p>Suivez les activités, gérez les licences et ajustez les paramètres selon l'évolution de vos besoins.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8 anim-fade-up">
                    ...
                    <p>Créez un compte et pilotez votre plateforme.</p>
                </div>
    ...
    <div class="gel-modal-overlay" id="authModal">
        <div class="gel-modal-box">
            ...
            <h3>Accédez à l'Administration</h3>
            <p>Créez un compte gratuitement pour gérer votre plateforme.</p>
