...
<body>
        ...
        <div class="container-fluid">
            ...
            <ul class="gel-nav-center">
                ...
                <li class="gel-nav-item">
                    ...
                    <ul class="gel-dropdown">
                        <li><a href="/services/comptabilite" style="background:var(--gel-primary-soft);color:var(--gel-primary);font-weight:600;"><span class="drop-icon"><i class="bi-calculator"></i></span> Comptabilité</a></li>
    ...
    <div class="gel-mobile-menu" id="gelMobileMenu">
        ...
        <a href="/services/comptabilite" class="gel-mobile-link" style="color:var(--gel-primary);font-weight:600;"><i class="bi-calculator text-orange me-2"></i>Comptabilité</a>
