...
<head>
    ...
    <title>Consultation | GEL Cabinet</title>
    <meta name="description" content="Service Consultation GEL Cabinet : accompagnement personnalisé, gestion de la relation client, missions, secrétariat, signatures électroniques et OCR.">
...
@include('partials.navbar')
    ...
    <div class="gel-page-header">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="gel-page-header-badge"><i class="bi-chat-dots"></i> Service</div>
                    <h1>Consultation</h1>
                    <p>Un accompagnement personnalisé pour votre entreprise : gestion de la relation client, pilotage des missions, secrétariat administratif, signatures électroniques et numérisation intelligente.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="col-lg-7 text-center">
                    <h2 class="gel-section-title anim-fade-up">Votre partenaire conseil</h2>
                    <p class="gel-section-sub mx-auto anim-fade-up delay-1">Des services de conseil et d'accompagnement pour piloter sereinement vos activités au quotidien.</p>
                </div>
            </div>
            <div class="row g-4">
                <div class="col-md-4 anim-fade-up delay-1">
                    <div class="gel-feature-card">
                        ...
                        <p>CRM intégré pour suivre vos clients, prospects, historiques d'échanges, documents partagés et actions en cours.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-2">
                    <div class="gel-feature-card">
                        <div class="gel-feature-icon"><i class="bi-check2-square"></i></div>
                        <h5>Pilotage des missions</h5>
                        <p>Planification, suivi et reporting des missions avec affectation des ressources, deadlines et livrables.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-3">
                    <div class="gel-feature-card">
                        <div class="gel-feature-icon"><i class="bi-file-text"></i></div>
                        <h5>Secrétariat administratif</h5>
                        <p>Gestion du courrier, des emails, de l'agenda, des modèles de documents et des tâches administratives courantes.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-1">
                    <div class="gel-feature-card">
                        <div class="gel-feature-icon"><i class="bi-pen"></i></div>
                        <h5>Signatures électroniques</h5>
                        <p>Signature électronique sécurisée de vos documents : devis, contrats, avenants, avec horodatage et preuve juridique.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-2">
                    <div class="gel-feature-card">
                        <div class="gel-feature-icon"><i class="bi-scanner"></i></div>
                        <h5>Numérisation OCR</h5>
                        <p>Reconnaissance optique de caractères pour numériser, indexer et rechercher automatiquement vos documents scannés.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-3">
                    <div class="gel-feature-card">
                        <div class="gel-feature-icon"><i class="bi-diagram-3"></i></div>
                        <h5>Workflows d'approbation</h5>
                        <p>Circuits de validation personnalisables pour vos documents et processus : devis, factures, contrats, notes de frais.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="col-lg-7 text-center">
                    ...
                    <p class="gel-section-sub mx-auto anim-fade-up delay-1">Un accompagnement structuré pour chaque besoin.</p>
                </div>
            </div>
            <div class="row g-4 justify-content-center">
                <div class="col-md-4 anim-fade-up delay-1">
                    <div class="gel-process-step">
                        ...
                        <h5>Diagnostic & Analyse</h5>
                        <p>Nous analysons vos besoins et vos processus pour vous proposer un accompagnement sur mesure adapté à votre activité.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-2">
                    <div class="gel-process-step">
                        ...
                        <h5>Mise en œuvre</h5>
                        <p>Déploiement des solutions adaptées : configuration des outils, définition des workflows et formation de vos équipes.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-3">
                    <div class="gel-process-step">
                        ...
                        <p>Accompagnement continu, suivi des indicateurs et ajustements réguliers pour une amélioration permanente.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8 anim-fade-up">
                    ...
                    <p>Contactez nos experts pour une consultation.</p>
                </div>
    ...
    <div class="gel-modal-overlay" id="authModal">
        <div class="gel-modal-box">
            ...
            <h3>Accédez au service Consultation</h3>
            <p>Créez un compte gratuitement pour bénéficier de nos services de conseil.</p>
