            ...
            <div class="row g-4">
                ...
                <div class="col-md-4 anim-fade-up delay-2">
                    <div class="gel-feature-card">
                        ...
                        <h5>Suivi des congés</h5>
                        <p>Gestion complète des congés payés, absences, arrêts maladie et jours fériés. Compteurs automatiques par employé.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-3">
                    <div class="gel-feature-card">
                        <div class="gel-feature-icon"><i class="bi-send"></i></div>
                        <h5>Déclarations CNSS</h5>
                        <p>Déclarations sociales obligatoires pré-remplies et transmises à la CNSS. Échéances et rappels intégrés.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-1">
                    <div class="gel-feature-card">
                        <div class="gel-feature-icon"><i class="bi-person-badge"></i></div>
                        <h5>Contrats &amp; Administratif</h5>
                        <p>Modèles de contrats CDI, CDD conformes au code du travail béninois. Gestion des avenants et des entrées/sorties.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-2">
                    <div class="gel-feature-card">
                        <div class="gel-feature-icon"><i class="bi-graph-up"></i></div>
                        <h5>Masse salariale &amp; Budget</h5>
                        <p>Analyse de la masse salariale, projections budgétaires et simulations. Tableaux de bord RH en temps réel.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-3">
                    <div class="gel-feature-card">
        ...
        <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="col-lg-7 text-center">
                    ...
                    <p class="gel-section-sub mx-auto anim-fade-up delay-1">De la saisie des données à la fiche de paie, un processus automatisé.</p>
                </div>
            </div>
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-md-4 anim-fade-up delay-2">
                    <div class="gel-process-step">
                        ...
                        <h5>Édition &amp; Déclaration</h5>
                        <p>Générez les fiches de paie conformes et les déclarations CNSS pré-remplies en un clic.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-3">
                    <div class="gel-process-step">
                        <div class="gel-process-num">3</div>
                        <h5>Suivi &amp; Reporting</h5>
                        <p>Suivez les congés, analysez la masse salariale et pilotez votre budget social en temps réel.</p>
                    </div>
                </div>
            </div>
        </div>
