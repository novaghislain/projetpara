...
<head>
    ...
    <meta name="description" content="Module Social &amp; Paie GEL Cabinet : gestion de la paie, déclarations sociales, contrats de travail et administration du personnel.">
    ...
    <style>
        :root {
            ...
            --gel-svc: #10B981; --gel-svc-rgb: 16,185,129;
...
<body>
            ...
            <ul class="gel-nav-center">
                ...
                <li class="gel-nav-item">
                    ...
                    <ul class="gel-dropdown">
                        ...
                        <li><a href="/services/social-paie" style="background:var(--gel-primary-soft);color:var(--gel-primary);font-weight:600;"><span class="drop-icon"><i class="bi-people"></i></span> Social & Paie</a></li>
                    </ul>
                </li>
                <li class="gel-nav-item">
    ...
    <div class="gel-mobile-menu" id="gelMobileMenu">
        ...
        <a href="/services/social-paie" class="gel-mobile-link" style="color:var(--gel-primary);font-weight:600;"><i class="bi-people text-orange me-2"></i>Social & Paie</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <h1>Social &amp; Paie</h1>
                    <p>Gérez la paie, les déclarations sociales et l'administration du personnel en un seul endroit — de l'embauche à la sortie.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="col-lg-7 text-center">
                    <h2 class="gel-section-title anim-fade-up">Gestion sociale intégrée</h2>
                    <p class="gel-section-sub mx-auto anim-fade-up delay-1">Un module complet pour centraliser toute l'administration sociale et la paie de votre cabinet.</p>
                </div>
            </div>
            <div class="row g-4">
                <div class="col-md-4 anim-fade-up delay-1">
                    <div class="gel-feature-card">
                        ...
                        <h5>Gestion de la paie</h5>
                        <p>Calcul automatique des salaires, cotisations, impôts et primes. Fiches de paie électroniques conformes.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-2">
                    <div class="gel-feature-card">
                        ...
                        <p>DSN, URSSAF, caisses de retraite, mutuelle — toutes vos déclarations sociales en un clic.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-3">
                    <div class="gel-feature-card">
                        <div class="gel-feature-icon"><i class="bi-person-badge"></i></div>
                        <h5>Contrats de travail</h5>
                        <p>Modèles de contrats CDI, CDD, stage, alternance. Gestion des avenants et renouvellements.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-1">
                    <div class="gel-feature-card">
                        <div class="gel-feature-icon"><i class="bi-calendar"></i></div>
                        <h5>Absences & Congés</h5>
                        <p>Suivi des congés, arrêts maladie, absences et RTT. Compteurs automatiques par collaborateur.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-2">
                    <div class="gel-feature-card">
                        <div class="gel-feature-icon"><i class="bi-bar-chart"></i></div>
                        <h5>Tableaux de bord sociaux</h5>
                        <p>Indicateurs sociaux, masse salariale, effectifs, turn-over — vue d'ensemble en temps réel.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-3">
                    <div class="gel-feature-card">
                        <div class="gel-feature-icon"><i class="bi-shield-check"></i></div>
                        <h5>Conformité & Archives</h5>
                        <p>Archivage électronique des documents sociaux. Conformité RGPD et obligations légales.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-md-4 anim-fade-up delay-1">
                    <div class="gel-process-step">
                        ...
                        <h5>Administration du personnel</h5>
                        <p>Gestion des entrées, sorties, contrats et dossiers individuels de chaque collaborateur.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-2">
                    <div class="gel-process-step">
                        <div class="gel-process-num">2</div>
                        <h5>Paie & Déclarations</h5>
                        <p>Calcul de la paie, édition des bulletins et génération des déclarations sociales périodiques.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-3">
                    <div class="gel-process-step">
                        <div class="gel-process-num">3</div>
                        <h5>Reporting & Analyse</h5>
                        <p>Tableaux de bord sociaux, analyse de la masse salariale et reporting direction.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8 anim-fade-up">
                    <h2>Prêt à simplifier votre gestion sociale ?</h2>
                    <p>Créez un compte et testez le module Social & Paie.</p>
                </div>
    ...
    <div class="gel-modal-overlay" id="authModal">
        <div class="gel-modal-box">
            ...
            <h3>Accédez au service Social & Paie</h3>
            <p>Créez un compte gratuitement pour utiliser le module Social & Paie.</p>
