...
<body>
            ...
            <ul class="gel-nav-center">
                ...
                <li class="gel-nav-item">
                    ...
                    <ul class="gel-dropdown">
                        ...
                        <li><a href="/services/juridique" style="background:var(--gel-primary-soft);color:var(--gel-primary);font-weight:600;"><span class="drop-icon"><i class="bi-bank2"></i></span> Juridique</a></li>
    ...
    <div class="gel-mobile-menu" id="gelMobileMenu">
        ...
        <a href="/services/juridique" class="gel-mobile-link" style="color:var(--gel-primary);font-weight:600;"><i class="bi-bank2 text-orange me-2"></i>Juridique</a>
