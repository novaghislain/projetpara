...
<head>
    ...
    <style>
        :root {
            ...
            --gel-svc: #8B5CF6; --gel-svc-rgb: 139,92,246;
...
<body>
            ...
            <ul class="gel-nav-center">
                ...
                <li class="gel-nav-item">
                    ...
                    <ul class="gel-dropdown">
                        ...
                        <li><a href="/services/fiscal" style="background:var(--gel-primary-soft);color:var(--gel-primary);font-weight:600;"><span class="drop-icon"><i class="bi-receipt"></i></span> Fiscal</a></li>
    ...
    <div class="gel-mobile-menu" id="gelMobileMenu">
        ...
        <a href="/services/fiscal" class="gel-mobile-link" style="color:var(--gel-primary);font-weight:600;"><i class="bi-receipt text-orange me-2"></i>Fiscal</a>
