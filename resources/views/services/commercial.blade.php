...
<head>
    ...
    <title>Commercial & Facturation | GEL Cabinet</title>
    <meta name="description" content="Module Commercial GEL Cabinet : suivi commercial, facturation, devis, relances, contrats de prestation et gestion des clients.">
...
<body>
            ...
            <ul class="gel-nav-center">
                ...
                <li class="gel-nav-item">
                    ...
                    <ul class="gel-dropdown">
                        ...
                        <li><a href="/services/commercial" style="background:var(--gel-primary-soft);color:var(--gel-primary);font-weight:600;"><span class="drop-icon"><i class="bi-cart3"></i></span> Commercial</a></li>
    ...
    <div class="gel-mobile-menu" id="gelMobileMenu">
        ...
        <a href="/services/commercial" class="gel-mobile-link" style="color:var(--gel-primary);font-weight:600;"><i class="bi-cart3 text-orange me-2"></i>Commercial</a>
    ...
    <div class="gel-page-header">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="gel-page-header-badge"><i class="bi-cart3-fill"></i> Service</div>
                    <h1>Commercial & Facturation</h1>
                    <p>Gérez votre cycle commercial complet — devis, factures, relances et contrats — avec un suivi en temps réel de votre activité et de vos clients.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="col-lg-7 text-center">
                    <h2 class="gel-section-title anim-fade-up">Cycle commercial complet</h2>
                    <p class="gel-section-sub mx-auto anim-fade-up delay-1">Du devis à la relance, tout votre cycle commercial dans un seul outil.</p>
                </div>
            </div>
            <div class="row g-4">
                <div class="col-md-4 anim-fade-up delay-1">
                    <div class="gel-feature-card">
                        ...
                        <h5>Devis professionnels</h5>
                        <p>Créez des devis personnalisés avec votre propre template. Validation, signature et transformation en facture en un clic.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-2">
                    <div class="gel-feature-card">
                        <div class="gel-feature-icon"><i class="bi-receipt"></i></div>
                        <h5>Facturation</h5>
                        <p>Génération de factures avec séries automatiques, échéances, TVA et modes de règlement. Factures récurrentes et abonnements.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-3">
                    <div class="gel-feature-card">
                        <div class="gel-feature-icon"><i class="bi-send"></i></div>
                        <h5>Relances automatisées</h5>
                        <p>Relances clients intelligentes avec planification automatique. Suivi des impayés et historique des relances.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-1">
                    <div class="gel-feature-card">
                        <div class="gel-feature-icon"><i class="bi-file-text"></i></div>
                        <h5>Contrats de prestation</h5>
                        <p>Gestion des contrats de prestation avec échéances, renouvellements automatiques et archivage des avenants.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-2">
                    <div class="gel-feature-card">
                        ...
                        <p>Pipeline des affaires, tableau de bord des ventes, objectifs et indicateurs de performance commerciale.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-3">
                    <div class="gel-feature-card">
                        ...
                        <p>Fiches clients avec historique complet des échanges, devis, factures et contrats. Segmentation par secteur ou type.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="col-lg-7 text-center">
                    ...
                    <p class="gel-section-sub mx-auto anim-fade-up delay-1">De la prospection à l'encaissement, un processus fluide.</p>
                </div>
            </div>
            <div class="row g-4 justify-content-center">
                <div class="col-md-4 anim-fade-up delay-1">
                    <div class="gel-process-step">
                        ...
                        <h5>Devis & Proposition</h5>
                        <p>Créez un devis personnalisé pour votre prospect ou client. Suivez son statut (envoyé, relu, accepté, refusé).</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-2">
                    <div class="gel-process-step">
                        <div class="gel-process-num">2</div>
                        <h5>Facturation & Encaissement</h5>
                        <p>Transformez le devis en facture, paramétrez les échéances et suivez les paiements en temps réel.</p>
                    </div>
                </div>
                <div class="col-md-4 anim-fade-up delay-3">
                    <div class="gel-process-step">
                        ...
                        <h5>Suivi & Relance</h5>
                        <p>Tableau de bord commercial, relances automatiques et reporting pour piloter votre activité.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8 anim-fade-up">
                    <h2>Prêt à booster votre commerce ?</h2>
                    <p>Créez un compte et testez le module Commercial & Facturation.</p>
                </div>
    ...
    <div class="gel-modal-overlay" id="authModal">
        <div class="gel-modal-box">
            ...
            <h3>Accédez au service Commercial</h3>
            <p>Créez un compte gratuitement pour utiliser le module Commercial & Facturation.</p>
