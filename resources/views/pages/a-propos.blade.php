...
<body>
    ...
    <header class="gel-page-header">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <h1 class="anim-fade-up delay-1">À propos de GEL Cabinet</h1>
                    <p class="anim-fade-up delay-2">Découvrez qui nous sommes, notre histoire, et rejoignez notre équipe.</p>
                </div>
            </div>
        </div>
    </header>
    ...
    <div class="gel-section">
        <div class="container">
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-md-4">
                    <a href="/notre-cabinet" class="text-decoration-none h-100">
                        <div class="gel-card anim-fade-up">
                            <div class="gel-card-icon"><i class="bi-building"></i></div>
                            <h5 style="color:var(--gel-dark);">Notre Cabinet</h5>
                            <p>Découvrez notre histoire, nos valeurs et la mission qui nous anime au quotidien.</p>
                        </div>
                    </a>
                </div>

                <div class="col-md-4">
                    <a href="/notre-equipe" class="text-decoration-none h-100">
                        <div class="gel-card anim-fade-up delay-1">
                            <div class="gel-card-icon"><i class="bi-people-fill"></i></div>
                            <h5 style="color:var(--gel-dark);">Notre Équipe</h5>
                            <p>Rencontrez les experts, consultants et collaborateurs qui font le succès de GEL.</p>
                        </div>
                    </a>
                </div>

                <div class="col-md-4">
                    <a href="/carrieres" class="text-decoration-none h-100">
                        <div class="gel-card anim-fade-up delay-2">
                            <div class="gel-card-icon"><i class="bi-briefcase-fill"></i></div>
                            <h5 style="color:var(--gel-dark);">Carrières</h5>
                            <p>Rejoignez-nous ! Découvrez nos offres d'emploi et opportunités de carrière.</p>
                        </div>
                    </a>
                </div>
