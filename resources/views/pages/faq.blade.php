...
<body>
            ...
            <ul class="gel-nav-center">
                ...
                <li class="gel-nav-item"><a href="#" class="gel-nav-link active">Ressources <i class="bi-chevron-down chevron"></i></a>
                    <ul class="gel-dropdown">
                        ...
                        <li><a href="/faq" style="background:var(--gel-primary-soft);color:var(--gel-primary);font-weight:600;"><span class="drop-icon"><i class="bi-question-circle"></i></span> FAQ</a></li>
                        <li><hr class="gel-dropdown-divider"></li>
    ...
    <div class="gel-mobile-menu" id="gelMobileMenu">
        ...
        <a href="/faq" class="gel-mobile-link" style="color:var(--gel-primary);font-weight:600;"><i class="bi-question-circle text-orange me-2"></i>FAQ</a>
