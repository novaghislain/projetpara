...
<head>
  ...
  <title>@yield('title', 'GEL Legal') — Cabinet Comptable</title>
...
<body>
  ...
  <header class="gel-topbar">
    ...
    <div class="topbar-right">
      ...
      <!-- APP SWITCHER -->
      <div style="position:relative;">
        <button class="topbar-btn" title="Applications GEL" onclick="toggleDropdown('appSwitcherDdLegal')">
          <i class="fas fa-th"></i>
        </button>
        <div class="nested-dropdown" id="appSwitcherDdLegal" style="position:absolute;right:0;left:auto;top:calc(100% + 6px);width:320px;padding:0;">
      ...
      <a href="{{ route('gel-legal.settings') ?? '#' }}" class="topbar-btn" title="Paramètres"><i class="fas fa-cog"></i></a>
      ...
      <div style="position:relative;">
        ...
        <div class="nested-dropdown" id="userDropdown"
          ...
          <div style="padding:12px 14px;border-bottom:1px solid var(--gel-border);">
            ...
            <div style="font-size:11px;color:var(--gel-primary);font-weight:500;margin-top:2px;">Juridique</div>
          </div>
