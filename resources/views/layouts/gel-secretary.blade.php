...
<head>
  ...
  <style>
    *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
    ...
    html { font-size:14px; }
    body { font-family:'Inter',-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif; color:var(--sec-text); background:var(--sec-bg); min-height:100vh; }
    a { text-decoration:none; color:inherit; }

    /* ─── TOPBAR ─── */
    .sec-topbar {
      position:fixed; top:0; left:var(--sec-sidebar-w); right:0;
      height:var(--sec-topbar-h);
      background:var(--sec-primary);
      display:flex; align-items:center; padding:0 20px; gap:12px;
      z-index:1000; border-bottom:2px solid var(--sec-primary-dark);
    }
    .sec-topbar-brand {
      font-weight:700; font-size:16px; color:white; white-space:nowrap;
    }
    .sec-topbar-brand small {
      font-size:11px; font-weight:400; opacity:.75; margin-left:6px;
    }
    ...
    .sec-client-switcher {
      ...
      font-size:13px; color:white; max-width:240px;
      position:relative;
    }
    .sec-client-switcher:hover { background:rgba(255,255,255,0.25); }
    ...
    .client-dropdown {
      ...
      box-shadow:var(--sec-shadow); z-index:200;
      display:none; padding:6px 0; max-height:320px; overflow-y:auto;
    }
    ...
    .sec-omnisearch::placeholder { color: rgba(255,255,255,0.7); }
    .sec-omnisearch:focus { background: rgba(255,255,255,0.25); width: 300px; }
    
    /* Notification Badge */
    .sec-topbar-btn { position: relative; }
    .notif-badge {
    ...
    .client-dd-item {
      ...
      padding:9px 14px; cursor:pointer; font-size:13px; color:var(--sec-text);
    }
    .client-dd-item:hover { background:#F8FAFC; }
    .client-dd-item.active { background:var(--sec-primary-light); color:var(--sec-primary); font-weight:600; }
    .client-dd-avatar {
      width:28px; height:28px; border-radius:50%; background:var(--sec-primary);
      color:white; font-size:11px; font-weight:700;
      display:flex; align-items:center; justify-content:center; flex-shrink:0;
    }

    .sec-topbar-right { margin-left:auto; display:flex; align-items:center; gap:6px; }
    .sec-topbar-btn {
    ...
    .sec-topbar-btn:hover { background:rgba(255,255,255,0.3); }
    .sec-avatar {
      width:32px; height:32px; border-radius:50%;
      background:white; color:var(--sec-primary);
    ...
    .sec-sidebar-title { font-size:14px; font-weight:700; color:white; }
    .sec-sidebar-sub { font-size:11px; color:rgba(255,255,255,0.7); }

    .sec-nav { list-style:none; padding:8px; flex:1; }
    .sec-nav-section { font-size:10px; font-weight:700; color:rgba(255,255,255,0.5); text-transform:uppercase; letter-spacing:.6px; padding:14px 10px 4px; }
    .sec-nav-item {
      display:flex; align-items:center; gap:10px;
      padding:10px 14px; margin: 0 0 4px 12px; border-radius:20px 0 0 20px; position:relative;
      font-size:13px; color:rgba(255,255,255,0.75); cursor:pointer;
      transition:all 100ms;
    }
    .sec-nav-item:hover { background:rgba(255,255,255,0.1); color:white; }
        .sec-nav-item.active {
      background:var(--sec-bg); color:var(--sec-primary);
      font-weight:600;
    }
    ...
    .sec-nav-item.active::before {
        ...
        box-shadow: 10px 10px 0 10px var(--sec-bg);
    }
    .sec-nav-item.active::after {
        top: 100%;
    ...
    .sec-nav-item i { width:16px; text-align:center; font-size:14px; }
    .sec-nav-badge {
      margin-left:auto; background:var(--sec-danger);
    ...
    .sec-sidebar-footer-name { font-size:12px; font-weight:600; color:white; }
    .sec-sidebar-footer-role { font-size:10px; color:rgba(255,255,255,0.7); }
    ...
    .sec-kpi {
      background:white; border:1px solid var(--sec-border); border-radius:8px;
    ...
    .sec-kpi-icon.teal { background:#F0FDFA; color:#0D9488; }
    .sec-kpi-icon.blue { background:#EFF6FF; color:#3B82F6; }
    .sec-kpi-icon.amber { background:#FFFBEB; color:#F59E0B; }
    .sec-kpi-icon.violet { background:#F5F3FF; color:#7C3AED; }
    .sec-kpi-val { font-size:26px; font-weight:700; color:var(--sec-text); line-height:1; }
    .sec-kpi-label { font-size:12px; color:var(--sec-text-muted); margin-top:2px; }
    ...
    .sec-card-header {
      padding:14px 18px; border-bottom:1px solid var(--sec-border);
      display:flex; align-items:center; justify-content:space-between;
    }
    .sec-card-title { font-size:14px; font-weight:700; color:var(--sec-text); }
    ...
    .sec-table th {
      ...
      color:var(--sec-text-muted); font-size:11px; font-weight:600;
      text-transform:uppercase; letter-spacing:.5px;
    }
    .sec-table td { padding:11px 14px; border-bottom:1px solid #F3F4F6; }
    .sec-table tr:last-child td { border-bottom:none; }
    .sec-table tr:hover td { background:#FAFAFA; }
    ...
    .sec-badge-success { background:#ECFDF5; color:#10B981; }
    .sec-badge-warning { background:#FFFBEB; color:#F59E0B; }
    .sec-badge-info { background:#EFF6FF; color:#3B82F6; }
    .sec-badge-danger { background:#FEF2F2; color:#EF4444; }
    .sec-badge-muted { background:#F3F4F6; color:#6B7280; }
    ...
    .sec-btn-sm { padding:5px 10px; font-size:12px; }
    .sec-btn-primary { background:var(--sec-primary); color:white; }
    .sec-btn-primary:hover { background:var(--sec-primary-dark); color:white; }
    .sec-btn-secondary { background:white; color:var(--sec-text); border:1px solid var(--sec-border); }
    .sec-btn-secondary:hover { background:#F8FAFC; }

    /* ─── PAGE HEADER ─── */
    .sec-page-header { display:flex; align-items:center; justify-content:space-between; margin-bottom:20px; }
    .sec-page-title { font-size:20px; font-weight:700; color:var(--sec-text); }
    .sec-page-sub { font-size:12px; color:var(--sec-text-muted); margin-top:2px; }

    /* ─── AVATAR INITIALS ─── */
    .sec-initials {
      width:32px; height:32px; border-radius:50%; background:var(--sec-primary);
      color:white; display:flex; align-items:center; justify-content:center;
      font-size:11px; font-weight:700; flex-shrink:0;
    }

    /* ─── FORM ─── */
    .sec-form-group { display:flex; flex-direction:column; margin-bottom:14px; }
    .sec-form-group label { font-size:12px; font-weight:600; color:var(--sec-text); margin-bottom:5px; }
    .sec-form-control, .sec-form-select {
      padding:8px 12px; border:1px solid var(--sec-border); border-radius:5px;
      font-size:13px; font-family:inherit; transition:border-color 120ms;
      width:100%; background:white;
    }
    .sec-form-control:focus, .sec-form-select:focus {
      outline:none; border-color:var(--sec-primary);
      box-shadow:0 0 0 3px rgba(13,148,136,.1);
    }

    /* ─── DROPDOWN (topbar) ─── */
    .sec-dropdown {
      position:absolute; background:white; border:1px solid var(--sec-border);
      border-radius:8px; box-shadow:var(--sec-shadow); padding:6px 0;
      min-width:200px; z-index:1100;
      display:none;
    }
    .sec-dropdown.open { display:block; }
    .sec-dd-item {
      display:flex; align-items:center; gap:8px;
      padding:8px 14px; cursor:pointer; font-size:13px; color:var(--sec-text);
    }
    .sec-dd-item:hover { background:#F8FAFC; }
    .sec-dd-divider { height:1px; background:var(--sec-border); margin:4px 0; }
    ...
    .sec-toast {
      ...
      background: var(--sec-primary); color: #ffffff;
      padding: 12px 16px; border-radius: 8px;
      box-shadow: 0 10px 25px rgba(0, 0, 0, 0.15);
      display: flex; align-items: center; gap: 12px;
      font-size: 13px; font-weight: 500; min-width: 250px; max-width: 350px; overflow: hidden;
    ...
    .sec-toast-content { flex: 1; display: flex; flex-direction: column; }
    .sec-toast-message { color: #ffffff; line-height: 1.4; }
    .sec-toast.err, .sec-toast.error { background: #EF4444; }
    .sec-toast.warn, .sec-toast.warning { background: #F59E0B; }
    .sec-toast.info { background: #3B82F6; }
    .sec-toast.exit { animation: secToastSlideDown 250ms cubic-bezier(0.4, 0, 1, 1) forwards; }
    @keyframes secToastSlideUp { from { transform: translateY(40px) scale(0.95); opacity: 0; } to { transform: translateY(0) scale(1); opacity: 1; } }
    @keyframes secToastSlideDown { from { transform: translateY(0) scale(1); opacity: 1; } to { transform: translateY(20px) scale(0.95); opacity: 0; } }
    @keyframes secToastProgress { from { width: 100%; } to { width: 0%; } }
    ...
    nav[role="navigation"] a, nav[role="navigation"] span { text-decoration: none; }
  </style>
  @stack('styles')
...
<header class="sec-topbar">
    ...
    <div class="client-dropdown" id="clientDropdown">
      @forelse($clients as $c)
        <form method="POST" action="{{ route('gel-secretary.switch-client') }}" style="margin:0;">
          ...
          <button type="submit" class="client-dd-item w-100 border-0 text-start {{ $activeClient?->id == $c->id ? 'active' : '' }}">
  ...
  <div style="margin-left: 20px; position: relative; flex:1; max-width:400px;">
    <i class="fas fa-magic" style="position: absolute; left: 12px; top: 50%; transform: translateY(-50%); font-size: 12px; color: rgba(255,255,255,0.7);"></i>
    <input type="text" id="omnisearchInput" class="sec-omnisearch" placeholder="Chercher, ou demandez à l'IA (Ex: Prépare une lettre...)" style="padding-left: 32px; width:100%; max-width:100%;">
    ...
    <div class="sec-dropdown" id="searchDd" style="left:0; right:auto; top:calc(100% + 6px); width:450px; padding:0;">
      <div id="searchResults" style="max-height:400px; overflow-y:auto; padding:8px 0;">
        <div style="padding:16px; text-align:center; color:var(--sec-text-muted); font-size:12px;">Tapez au moins 2 caractères ou donnez un ordre à GEL Intelligence...</div>
      </div>
    </div>
  </div>
  ...
  <div class="sec-topbar-right">
    ...
    <div style="position:relative;">
      <button class="sec-topbar-btn" title="Actions Rapides" onclick="toggleSecDropdown('quickActionsDd')" style="background:var(--sec-success); box-shadow:0 0 10px rgba(16, 185, 129, 0.4);">
        <i class="fas fa-plus"></i>
      </button>
      <div class="sec-dropdown" id="quickActionsDd" style="right:0;top:calc(100% + 6px); width:200px; padding:8px 0;">
        <a href="{{ route('gel-secretary.courriers.index') }}" class="sec-dd-item text-decoration-none"><i class="fas fa-envelope-open-text" style="color:#0D9488;width:20px;"></i> Nouveau courrier</a>
        <a href="{{ route('gel-secretary.contacts.index') }}" class="sec-dd-item text-decoration-none"><i class="fas fa-address-book" style="color:#F59E0B;width:20px;"></i> Nouveau contact</a>
        <a href="{{ route('gel-secretary.documents.index') }}" class="sec-dd-item text-decoration-none" onclick="document.getElementById('quickUploadModal').style.display='flex'"><i class="fas fa-file-upload" style="color:#3B82F6;width:20px;"></i> Nouveau document</a>
        <a href="{{ route('gel-secretary.agenda.index') }}" class="sec-dd-item text-decoration-none"><i class="fas fa-calendar-plus" style="color:#8B5CF6;width:20px;"></i> Nouvelle réunion</a>
        <a href="{{ route('gel-secretary.tasks.index') }}" class="sec-dd-item text-decoration-none"><i class="fas fa-tasks" style="color:#10B981;width:20px;"></i> Nouvelle tâche</a>
      </div>
    </div>
    ...
    <div style="position:relative;">
      <button class="sec-topbar-btn" title="Notifications" onclick="toggleSecDropdown('notifDd')">
        ...
        <span class="notif-badge" id="notifBadge" style="display:block;">4</span>
      </button>
      <div class="sec-dropdown" id="notifDd" style="right:0;top:calc(100% + 6px); width:320px; padding:0;">
        <div style="padding:12px 14px; border-bottom:1px solid var(--sec-border); font-weight:700; font-size:13px; background:#F8FAFC; border-radius:8px 8px 0 0; display:flex; justify-content:space-between; align-items:center;">
        ...
        <div id="notifList" style="max-height:300px; overflow-y:auto; padding:0;">
          <div style="padding:12px; border-bottom:1px solid #f1f5f9; display:flex; gap:12px; align-items:flex-start; cursor:pointer;" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='transparent'">
            <div style="width:32px; height:32px; border-radius:50%; background:#EFF6FF; color:#3B82F6; display:flex; align-items:center; justify-content:center; flex-shrink:0;"><i class="fas fa-comment-dots"></i></div>
            <div>
              <div style="font-size:12px; font-weight:600; color:var(--sec-text);">David vous a envoyé un message</div>
              <div style="font-size:11px; color:var(--sec-text-muted);">À propos de la réunion de demain.</div>
            </div>
          </div>
          <div style="padding:12px; border-bottom:1px solid #f1f5f9; display:flex; gap:12px; align-items:flex-start; cursor:pointer;" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='transparent'">
            ...
            <div>
              <div style="font-size:12px; font-weight:600; color:var(--sec-text);">Deux tâches arrivent à échéance</div>
              <div style="font-size:11px; color:var(--sec-text-muted);">Relance devis TechInnov et TVA.</div>
            </div>
          </div>
          <div style="padding:12px; border-bottom:1px solid #f1f5f9; display:flex; gap:12px; align-items:flex-start; cursor:pointer;" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='transparent'">
            <div style="width:32px; height:32px; border-radius:50%; background:#F5F3FF; color:#8B5CF6; display:flex; align-items:center; justify-content:center; flex-shrink:0;"><i class="fas fa-check-double"></i></div>
            <div>
              <div style="font-size:12px; font-weight:600; color:var(--sec-text);">Le Directeur a validé un document</div>
              <div style="font-size:11px; color:var(--sec-text-muted);">Contrat de prestation validé.</div>
            </div>
          </div>
          <div style="padding:12px; display:flex; gap:12px; align-items:flex-start; cursor:pointer;" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='transparent'">
            <div style="width:32px; height:32px; border-radius:50%; background:#ECFDF5; color:#10B981; display:flex; align-items:center; justify-content:center; flex-shrink:0;"><i class="fas fa-calendar-check"></i></div>
            <div>
              <div style="font-size:12px; font-weight:600; color:var(--sec-text);">Un client a accepté un rendez-vous</div>
              <div style="font-size:11px; color:var(--sec-text-muted);">M. Dupont a confirmé pour jeudi 14h.</div>
            </div>
          </div>
        </div>
        <div style="padding:8px; border-top:1px solid var(--sec-border); text-align:center;">
          <a href="#" style="font-size:12px; color:var(--sec-primary); font-weight:500;">Marquer tout comme lu</a>
        </div>
      </div>
    </div>
    ...
    <div style="position:relative;">
      ...
      <div class="sec-dropdown" id="userDd" style="right:0;top:calc(100% + 6px);">
        <div style="padding:10px 14px;border-bottom:1px solid var(--sec-border);">
          ...
          <div style="font-size:11px;color:var(--sec-primary);font-weight:600;margin-top:2px;">Secrétaire de cabinet</div>
        </div>
        <div class="sec-dd-item" style="color:var(--sec-info); font-weight:600; background:#EFF6FF;" onclick="alert('Passage en Mode Direction (Bientôt disponible)')">
          <i class="fas fa-user-tie"></i> Passer en Mode Direction
        </div>
...
<aside class="sec-sidebar">
  ...
  <ul class="sec-nav">
    ...
    <li>
      <a href="{{ route('gel-secretary.invitations.index') }}"
         class="sec-nav-item {{ request()->routeIs('gel-secretary.invitations.*') ? 'active' : '' }}">
        ...
        @endphp
        @if($inv_count > 0)
          <span style="background:#EF4444; color:white; font-size:10px; padding:2px 6px; border-radius:10px; margin-left:auto;">{{ $inv_count }}</span>
        @endif
      </a>
    </li>
    ...
    <li>
      <a href="{{ route('gel-secretary.courriers.index') }}" class="sec-nav-item {{ request()->routeIs('gel-secretary.courriers.*') ? 'active' : '' }}">
        <i class="fas fa-envelope-open-text"></i> Courriers
      </a>
    </li>
    <li>
      <a href="{{ route('gel-secretary.calls.index') }}" class="sec-nav-item {{ request()->routeIs('gel-secretary.calls.*') ? 'active' : '' }}">
        <i class="fas fa-phone-alt"></i> Journal d'appels
      </a>
    </li>
    <li>
      <a href="{{ route('gel-secretary.messagerie.index') }}" class="sec-nav-item {{ request()->routeIs('gel-secretary.messagerie.*') ? 'active' : '' }}">
    ...
    <li>
      <a href="{{ route('gel-secretary.tasks.index') }}" class="sec-nav-item {{ request()->routeIs('gel-secretary.tasks.*') ? 'active' : '' }}">
        <i class="fas fa-tasks"></i> Tâches
      </a>
    </li>
    <li>
      <a href="{{ route('gel-secretary.relances.index') }}" class="sec-nav-item {{ request()->routeIs('gel-secretary.relances.*') ? 'active' : '' }}">
    ...
    <li>
      <a href="{{ route('gel-secretary.settings.index') }}" class="sec-nav-item {{ request()->routeIs('gel-secretary.settings.*') ? 'active' : '' }}">
  ...
  <div id="aiWidgetPanel" class="ai-widget-panel shadow-lg">
    ...
    <div id="aiWidgetBody" class="ai-widget-body">
      <div class="ai-msg received">
        Bonjour ! Je suis votre assistant IA. Avez-vous une question concernant {{ $activeClient?->company_name ?? 'vos dossiers' }} ?
      </div>
    </div>

    <div class="ai-widget-footer">
      <form id="aiWidgetForm" class="d-flex gap-2">
        <input type="text" id="aiWidgetInput" class="form-control form-control-sm" placeholder="Posez votre question..." required autocomplete="off" style="font-size:13px; border-radius:20px; padding-left:14px;">
        <button type="submit" class="btn btn-sm" style="background:var(--sec-primary); color:white; border-radius:50%; width:32px; height:32px; display:flex; align-items:center; justify-content:center; flex-shrink:0;">
...
<style>
  .ai-widget-container { position: fixed; bottom: 24px; right: 24px; z-index: 1050; }
  .ai-widget-btn { width: 56px; height: 56px; border-radius: 50%; background: linear-gradient(135deg, var(--sec-primary) 0%, var(--sec-primary-dark) 100%); color: white; border: none; font-size: 24px; cursor: pointer; display: flex; align-items: center; justify-content: center; transition: transform 0.2s, box-shadow 0.2s; }
  .ai-widget-btn:hover { transform: scale(1.05); box-shadow: 0 10px 20px rgba(13, 148, 136, 0.3) !important; }
  .ai-widget-panel { position: absolute; bottom: 70px; right: 0; width: 340px; height: 450px; background: white; border-radius: 16px; display: none; flex-direction: column; overflow: hidden; transform-origin: bottom right; animation: aiPanelPop 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275); border: 1px solid var(--sec-border); }
  @keyframes aiPanelPop { 0% { opacity: 0; transform: scale(0.8) translateY(20px); } 100% { opacity: 1; transform: scale(1) translateY(0); } }
  .ai-widget-panel.show { display: flex; }
  .ai-widget-header { background: linear-gradient(135deg, var(--sec-primary) 0%, var(--sec-primary-dark) 100%); color: white; padding: 12px 16px; display: flex; align-items: center; justify-content: space-between; }
  .ai-avatar { width: 32px; height: 32px; background: rgba(255,255,255,0.2); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 14px; }
  .ai-widget-body { flex: 1; padding: 16px; overflow-y: auto; background: #F8FAFC; display: flex; flex-direction: column; gap: 12px; }
  .ai-widget-footer { padding: 12px; background: white; border-top: 1px solid var(--sec-border); }
  
  .ai-msg { max-width: 85%; padding: 10px 14px; border-radius: 12px; font-size: 13px; line-height: 1.4; word-wrap: break-word; }
  .ai-msg.received { background: white; color: var(--sec-text); border: 1px solid var(--sec-border); align-self: flex-start; border-bottom-left-radius: 4px; box-shadow: 0 1px 2px rgba(0,0,0,0.02); }
  .ai-msg.sent { background: var(--sec-primary-light); color: var(--sec-primary-dark); border: 1px solid #CCFBF1; align-self: flex-end; border-bottom-right-radius: 4px; }
</style>
