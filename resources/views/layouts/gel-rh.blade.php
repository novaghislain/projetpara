...
<head>
  ...
  <title>@yield('title', 'GEL RH') — Cabinet Comptable</title>
  ...
  <style>
    ...
    *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    :root {
      --gel-primary: #8B5CF6;
      --gel-primary-hover: #7C3AED;
      --gel-primary-light: #EDE9FE;
      ...
      font-weight: 600;
        ...
        <div class="nested-dropdown" id="userDropdown"
          ...
          <div style="padding:12px 14px;border-bottom:1px solid var(--gel-border);">
            ...
            <div style="font-size:11px;color:var(--gel-primary);font-weight:500;margin-top:2px;">Ressources Humaines</div>
          </div>
