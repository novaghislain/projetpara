...
<head>
  ...
  <title>@yield('title', 'GEL Informatique') — Pôle Informatique</title>
  ...
  <style>
    ...
    *::after {
    ...
    :root {
      --sec-primary: #0a2540;
      --sec-primary-dark: #07192d;
      --sec-primary-light: #f6f9fc;
      --sec-sidebar-bg: #0f1b2d;
      --sec-sidebar-hover: rgba(255,255,255,0.1);
      --sec-sidebar-active-bg: rgba(10,37,64,0.1);
      --sec-sidebar-w: 230px;
      --sec-topbar-h: 54px;
      --sec-text: #1F2A44;
...
<body>
  ...
  <aside class="sec-sidebar">
    <div class="sec-sidebar-brand">
      <div class="sec-sidebar-icon"><i class="fas fa-server"></i></div>
      <div>
        <div class="sec-sidebar-title">Informatique</div>
        <div class="sec-sidebar-sub">GEL SABINET</div>
      </div>
    </div>
    ...
    <ul class="sec-nav">
      ...
      <li>
        <a href="{{ route('gel-informaticien.dashboard') }}"
          class="sec-nav-item {{ request()->routeIs('gel-informaticien.dashboard') ? 'active' : '' }}">
          <i class="fas fa-tachometer-alt"></i> Tableau de bord
        </a>
      </li>

      <li class="sec-nav-section">Support & Incidents</li>
      <li>
        <a href="{{ route('gel-informaticien.tickets.index') }}"
          class="sec-nav-item {{ request()->routeIs('gel-informaticien.tickets.*') ? 'active' : '' }}">
          <i class="fas fa-ticket-alt"></i> Tickets & Assistance
          @php
            $newTickets = \App\Models\ItTicket::where('status', 'nouveau')->count();
          @endphp
          @if($newTickets > 0)
            <span class="sec-nav-badge">{{ $newTickets }}</span>
          @endif
        </a>
      </li>

      <li class="sec-nav-section">Développement & Projets</li>
      <li>
        <a href="{{ route('gel-informaticien.dev-requests.index') }}"
          class="sec-nav-item {{ request()->routeIs('gel-informaticien.dev-requests.*') ? 'active' : '' }}">
          <i class="fas fa-code"></i> Demandes de Dev
        </a>
      </li>

      <li class="sec-nav-section">Infrastructures & Sécurité</li>
      <li>
        <a href="{{ route('gel-informaticien.security.index') }}"
          class="sec-nav-item {{ request()->routeIs('gel-informaticien.security.*') ? 'active' : '' }}">
          <i class="fas fa-shield-alt"></i> Sécurité & Accès
        </a>
      </li>
      <li class="nav-item">
          <a href="{{ route('gel-informaticien.missions.index') }}" class="sec-nav-item {{ request()->routeIs('gel-informaticien.missions.*') ? 'active' : '' }}">
              <i class="fas fa-briefcase"></i> Mes Missions (Client)
          </a>
      </li>
      <li class="nav-item">
          <a href="{{ route('gel-informaticien.equipment.index') }}" class="sec-nav-item {{ request()->routeIs('gel-informaticien.equipment.*') ? 'active' : '' }}">
              <i class="fas fa-boxes"></i> Commandes Matériel
          </a>
      </li>

      <li class="sec-nav-section">Communication & Média</li>
      <li>
        <a href="{{ route('gel-communication.calendar.index') }}"
          class="sec-nav-item {{ request()->routeIs('gel-communication.calendar*') ? 'active' : '' }}">
      ...
      <li>
        <a href="{{ route('gel-communication.briefs.index') }}"
          ...
          <i class="fas fa-file-alt"></i> Briefs Créatifs
        </a>
      </li>

      <li class="sec-nav-section">Administration</li>
      <li>
        <a href="{{ route('gel-informaticien.users.index') }}"
          class="sec-nav-item {{ request()->routeIs('gel-informaticien.users.*') ? 'active' : '' }}">
          <i class="fas fa-users-cog"></i> Utilisateurs & Droits
        </a>
      </li>

      <li class="sec-nav-section">Outils & Maintenance</li>
      <li>
        <a href="{{ route('gel-informaticien.maintenance.index') }}"
          class="sec-nav-item {{ request()->routeIs('gel-informaticien.maintenance.*') ? 'active' : '' }}">
          <i class="fas fa-server"></i> Santé Plateforme
        </a>
      </li>
    </ul>
    ...
    @if($u)
      <div class="sec-sidebar-footer">
        ...
        <div style="flex:1;min-width:0;">
          ...
          <div class="sec-sidebar-footer-role">Pôle Informatique</div>
        </div>
