...
<head>
    ...
    <title>GEL Business | Espace Administrateur</title>
    <meta name="description" content="Portail Administrateur d'Entreprise - GEL Sabinet">
    ...
    <style>
      :root {
        ...
        --bs-link-color: #F59E0B !important;
        --bs-link-hover-color: #D97706 !important;
        --gel-dark: #0F172A;
        --gel-primary: #F59E0B;
        --gel-secondary: #1E293B;
        --gel-accent: #F59E0B;
        --gel-light: #F8FAFC;
      }
      body {
