...
<div class="bento-grid">
    ...
    <div class="bento-card bento-welcome stagger-1">
        <div style="position:relative; z-index:2;">
            <div class="welcome-title">Bonjour {{ $user->nom ?? 'chère collaboratrice' }} 👋</div>
            <div class="welcome-sub">{{ now()->isoFormat('dddd D MMMM YYYY') }} — Voici un aperçu de votre portefeuille client. Prête à attaquer la journée ?</div>
