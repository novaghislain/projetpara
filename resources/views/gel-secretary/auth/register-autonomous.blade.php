...
<head>
  <meta charset="UTF-8">
  <title>GEL Secrétariat — Inscription Autonome</title>
...
<div class="auth-container">
  <div class="auth-header">
    <h1>GEL <span>Secrétariat</span></h1>
    <p>Création de votre espace personnel autonome</p>
  </div>
  <div class="auth-body">
    <form action="{{ route('gel-secretary.register.autonomous.submit') }}" method="POST">
      @csrf
      ...
      <div class="text-center mt-3" style="font-size: 13px;">
        <a href="{{ route('gel-secretary.register.choices') }}" style="color: #6B7280; text-decoration: none;"><i class="fas fa-arrow-left"></i> Retour au choix</a>
      </div>
