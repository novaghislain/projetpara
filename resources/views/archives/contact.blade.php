...
<head>
    ...
    <meta name="description"
        content="Contactez GEL Cabinet : Cotonou, Bénin. Téléphone, email, formulaire de contact et plan d'accès.">
    ...
    <style>
        ...
        * {
        ...
        .gel-nav-link .chevron {
            font-size: 10px;
            transition: transform var(--transition);
        }

        .gel-nav-item:hover>a .chevron {
        ...
        .gel-nav-item:hover .gel-dropdown {
            opacity: 1;
            visibility: visible;
        ...
        .gel-dropdown li a:hover {
            background: var(--gel-primary-soft);
            color: var(--gel-primary);
        }

        .gel-dropdown li a .drop-icon {
            width: 26px;
            height: 26px;
        ...
        .gel-mobile-link:last-child {
            border-bottom: none;
        }

        .gel-mobile-link:hover {
            color: var(--gel-primary);
        }
        ...
        .gel-page-header::before {
            ...
            width: 400px;
            height: 400px;
            background: radial-gradient(circle, rgba(var(--gel-svc-rgb), 0.12) 0%, transparent 70%);
            border-radius: 50%;
        ...
        .gel-page-header::after {
            ...
            width: 200px;
            height: 200px;
            background: radial-gradient(circle, rgba(var(--gel-svc-rgb), 0.08) 0%, transparent 70%);
            border-radius: 50%;
        ...
        .gel-contact-card:hover .gel-contact-card-icon {
            background: var(--gel-primary);
            color: #fff;
        }
        ...
        .gel-form-control:focus {
            border-color: var(--gel-primary);
            box-shadow: 0 0 0 3px rgba(255, 121, 0, 0.1);
        }

        .gel-form-control::placeholder {
            color: #c0cbd8;
        }

        textarea.gel-form-control {
            resize: vertical;
            min-height: 120px;
        }
            ...
            <div class="row g-4 align-items-stretch">
                ...
                <div class="col-lg-6 anim-fade-right">
                    <div class="gel-form-wrap">
                        ...
                        <div class="gel-form-sub">Remplissez le formulaire ci-dessous et nous vous répondrons dans les
                            plus brefs délais.</div>

                        @if(session('success'))
                            <div
                                style="background:#f0fdf4; border:1px solid #bbf7d0; color:#166534; border-radius:6px; padding:12px 16px; font-size:13px; margin-bottom:20px; display:flex; align-items:center; gap:8px;">
                        ...
                        <form method="POST" action="{{ route('contact') }}">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="name" class="gel-form-control" required
                                        placeholder="Votre nom">
                                </div>
                                <div class="col-md-6">
                                    <label class="gel-form-label">Email *</label>
                                    <input type="email" name="email" class="gel-form-control" required
                                        placeholder="votre@email.com">
                                </div>
                                <div class="col-md-6">
                                    <label class="gel-form-label">Téléphone</label>
                                    <input type="tel" name="phone" class="gel-form-control"
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="message" class="gel-form-control" rows="5" required
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 text-lg-end mt-4 mt-lg-0 anim-fade-up delay-1">
                    ...
                    <a href="/login" class="gel-btn-white"
                        style="background:rgba(255,255,255,0.15);color:#fff;border:2px solid rgba(255,255,255,0.5);display:inline-flex;margin-top:6px;"><i
                            class="bi-box-arrow-in-right"></i> Connexion</a>
                </div>
            </div>
        </div>
    </section>
