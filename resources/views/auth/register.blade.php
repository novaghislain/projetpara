            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-5">
                    <div class="text-center mb-4">
                        ...
                        <p class="text-muted small">Créez votre espace</p>
                    </div>
                    ...
                    <div class="card border-0 shadow-premium rounded-0 p-4 p-md-5">
                        <div class="text-center mb-4">
                            ...
                            <p class="text-muted small">Accédez à votre espace client GEL Cabinet</p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" class="form-control rounded-0 border-2 px-4 py-2"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="password" name="password_confirmation" class="form-control rounded-0 border-2 px-4 py-2"
                                    required placeholder="Retapez le mot de passe">
                            </div>
                            <button type="submit" class="btn btn-primary w-100 rounded-0 py-3 fw-bold shadow-sm">Créer mon compte</button>
