...
<head>
    ...
    <title>Mot de passe oublié | GEL Cabinet</title>
                ...
                <div class="col-md-5 col-lg-4">
                    ...
                    <div class="card border-0 shadow-premium rounded-0 p-4 p-md-5">
                        <div class="text-center mb-4">
                            ...
                            <p class="text-muted small">Entrez votre adresse email et nous vous enverrons un lien pour réinitialiser votre mot de passe.</p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('password.email') }}">
                            ...
                            <button type="submit" class="btn btn-primary w-100 rounded-0 py-3 fw-bold shadow-sm">
                                Envoyer le lien
                            </button>
                            <p class="text-center mt-4 small text-muted mb-0">
                                <a href="{{ route('login') }}" class="text-primary fw-bold text-decoration-none">
                                    <i class="bi-arrow-left me-1"></i>Retour à la connexion
                                </a>
                            </p>
                        </form>
                    </div>
