...
@section('title', 'Crédit retardé')

@section('content')

<div class="gel-page-header">
    <div>
        <h1 class="gel-page-title"><i class="fas fa-clock" style="color:var(--gel-primary); margin-right:8px;"></i> Crédit retardé</h1>
        <p class="gel-page-subtitle">Enregistrez un Crédit client À  appliquer ultérieurement sur une facture future.</p>
    </div>
...
<form method="POST" action="#" id="delayedCreditForm">
@csrf
...
<div class="gel-card p-4 mb-4">
    <div class="doc-form-grid">
        ...
        <div class="doc-form-group">
            <label class="doc-label">NÂ° du Crédit retardé</label>
            <input type="text" name="credit_number" class="doc-input" value="DC-{{ str_pad(rand(1,9999), 4, '0', STR_PAD_LEFT) }}" readonly>
        </div>
    </div>
</div>
...
<div style="display:grid; grid-template-columns:1fr 360px; gap:20px; margin-bottom:20px;">
    <div class="gel-card p-4 mb-4">
        <label class="doc-label">Message / Mémo</label>
        <textarea name="memo" class="doc-input" rows="3" placeholder="Ce Crédit sera appliqué À  la prochaine facture..."></textarea>
    </div>
    <div class="gel-card p-4 mb-4">
...
<div style="display:flex; justify-content:flex-end; gap:10px; padding-bottom:30px;">
    ...
    <button type="submit" class="gel-btn gel-btn-primary"><i class="fas fa-save"></i> Enregistrer le Crédit retardé</button>
</div>
</form>
