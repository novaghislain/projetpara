...
<div class="gel-page-header">
    <div>
        ...
        <p class="gel-page-subtitle">Analyse du chiffre d'affaires par période et par client.</p>
    </div>
...
<div class="gel-card" style="padding:48px; text-align:center; margin-top:20px;">
    ...
    <p style="color:var(--gel-text-secondary); max-width:480px; margin:0 auto 24px; line-height:1.6;">
        La page <strong>Chiffre d'Affaires</strong> est en cours d'implémentation et sera disponible très prochainement.
    </p>
