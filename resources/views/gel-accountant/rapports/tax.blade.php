...
<div class="gel-page-header">
    <div>
        ...
        <p class="gel-page-subtitle">Synthèse des obligations fiscales et TVA.</p>
    </div>
...
<div class="gel-card" style="padding:48px; text-align:center; margin-top:20px;">
    ...
    <p style="color:var(--gel-text-secondary); max-width:480px; margin:0 auto 24px; line-height:1.6;">
        La page <strong>Rapport Fiscal</strong> est en cours d'implémentation et sera disponible très prochainement.
    </p>
