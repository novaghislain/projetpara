...
<div class="gel-page-header">
    <div>
        <h1 class="gel-page-title">
            <i class="fas fa-users" style="color:var(--gel-primary); margin-right:8px;"></i>
            Balance Âgée Clients
        </h1>
        <p class="gel-page-subtitle">Analyse des créances par ancienneté.</p>
    </div>
...
<div class="gel-card" style="padding:48px; text-align:center; margin-top:20px;">
    ...
    <p style="color:var(--gel-text-secondary); max-width:480px; margin:0 auto 24px; line-height:1.6;">
        La page <strong>Balance Âgée Clients</strong> est en cours d'implémentation et sera disponible très prochainement.
    </p>
