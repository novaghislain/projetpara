...
@section('title', 'Ajouter un Client CRM')

@section('content')
<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    <div class="mb-8">
        <h1 class="text-2xl md:text-3xl text-slate-800 dark:text-slate-100 font-bold">Ajouter un Client CRM ✨</h1>
        <p class="text-sm text-slate-500">Créez une nouvelle fiche client pour la facturation.</p>
    </div>
    ...
    <div class="bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
        <form action="{{ route('gel-accountant.facturation.clients.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="company" class="form-input w-full" value="{{ old('company') }}" placeholder="Ex: Entreprise Alpha" />
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="last_name" class="form-input w-full" value="{{ old('last_name') }}" required />
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="email" name="email" class="form-input w-full" value="{{ old('email') }}" />
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="ifu" class="form-input w-full" value="{{ old('ifu') }}" />
                </div>
                <div>
                    <label class="block text-sm font-medium text-slate-800 dark:text-slate-100 mb-1">Numéro RCCM</label>
                    <input type="text" name="rccm" class="form-input w-full" value="{{ old('rccm') }}" />
                </div>
