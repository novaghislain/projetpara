...
@section('title', 'Nouveau Client - Comptable Indépendant')
...
<div class="gel-page-header" style="border-bottom: 1px solid var(--gel-border); padding-bottom: 12px; margin-bottom: 24px; display:flex; justify-content:space-between; align-items:flex-end;">
    <div>
        ...
        <h1 class="gel-page-title" style="font-size: 18px; font-weight: 700; color: var(--gel-text-primary); margin-bottom: 4px;">Ajouter un nouveau client</h1>
        <p class="gel-page-subtitle" style="font-size: 12px; color: var(--gel-text-secondary);">Créez un dossier isolé pour ce client</p>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-8">
        <div class="pro-panel">
            <div class="panel-body">
                <form action="{{ route('gel-accountant.independant.clients.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="ifu" class="form-control" value="{{ old('ifu') }}">
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="text-end mt-4 pt-3" style="border-top: 1px solid #eee;">
                        <button type="submit" class="gel-btn gel-btn-primary" style="font-weight: 600; padding: 8px 24px;">Enregistrer le client</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="col-lg-4">
        <div class="alert alert-info border-0 shadow-sm" style="background-color: #f8fbff; border-radius: 8px;">
            <h6 class="fw-bold mb-3"><i class="bi bi-shield-lock me-2 text-primary"></i> Isolation Garantie</h6>
            <p class="small text-muted mb-0">
                Ce dossier client est strictement isolé. Aucune donnée saisie ici (écritures, grand livre, documents) ne sera visible depuis vos autres dossiers clients.
            </p>
        </div>
    </div>
</div>
