...
<head>
    ...
    <style>
        /* Modern Glassmorphism & Bento Updates */
        body { background: #f4f7f6; position: relative; }
        .gel-blob-1 { position: fixed; top: -10%; left: -10%; width: 40%; height: 40%; background: rgba(59,130,246,0.08); border-radius: 50%; filter: blur(100px); pointer-events: none; z-index: -1; }
        .gel-blob-2 { position: fixed; bottom: -10%; right: -10%; width: 30%; height: 30%; background: rgba(255,121,0,0.08); border-radius: 50%; filter: blur(100px); pointer-events: none; z-index: -1; }

        .gel-why-card, .gel-service-card, .gel-testimonial-card, .gel-feature-item, .gel-pourqui-card, .gel-contact-info, .gel-form-wrap, .gel-blog-card {
        ...
        .gel-section-alt { background: transparent !important; }
        .gel-stats-band { background: rgba(255, 255, 255, 0.3) !important; backdrop-filter: blur(10px) !important; border-bottom: 1px solid rgba(255, 255, 255, 0.4) !important; }

        /* Modernize shadows on hover */
        .gel-why-card:hover, .gel-service-card:hover, .gel-testimonial-card:hover, .gel-feature-item:hover, .gel-pourqui-card:hover {
...
<body>
    <div class="gel-blob-1"></div>
    <div class="gel-blob-2"></div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="col-lg-8 text-center">
                    <h2 class="gel-section-title anim-fade-up delay-1">L'ERP SaaS conçu pour propulser votre croissance.</h2>
                    <p class="gel-section-sub mx-auto anim-fade-up delay-2">GEL Cabinet unifie votre comptabilité, vos ressources humaines, vos projets et votre trésorerie dans une plateforme fluide, sécurisée et boostée à l'Intelligence Artificielle.</p>
                </div>
            </div>
            <div class="row g-4 justify-content-center">
                <div class="col-md-6 anim-fade-up delay-1">
                    <div class="gel-why-card">
                        <div class="gel-why-icon"><i class="bi-calculator"></i></div>
                        <h6>Comptabilité & Finance</h6>
                        <p>Normes OHADA, journaux comptables automatiques, trésorerie prévisionnelle et états financiers en temps réel.</p>
                    </div>
                </div>
                <div class="col-md-6 anim-fade-up delay-2">
                    <div class="gel-why-card">
                        <div class="gel-why-icon"><i class="bi-robot"></i></div>
                        <h6>Extraction OCR (IA)</h6>
                        <p>Scannez vos factures, l'IA extrait les données et génère les écritures comptables instantanément.</p>
                    </div>
                </div>
                <div class="col-md-6 anim-fade-up delay-3">
                    <div class="gel-why-card">
                        <div class="gel-why-icon"><i class="bi-people"></i></div>
                        <h6>Portail Collaborateur</h6>
                        <p>Gestion des congés, fiches de paie, contrats dynamiques et LMS intégré pour vos équipes.</p>
                    </div>
                </div>
                <div class="col-md-6 anim-fade-up delay-4">
                    <div class="gel-why-card">
                        <div class="gel-why-icon"><i class="bi-building"></i></div>
                        <h6>Architecture Multi-Tenants SaaS</h6>
                        <p>Déployez des instances ERP sécurisées par secteur d'activité (BTP, Santé, Commerce) avec des modules à la carte. Chaque client possède son espace de données étanche avec portabilité complète (RGPD).</p>
                    </div>
                </div>
            </div>
        </div>
