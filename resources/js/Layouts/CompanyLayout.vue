...
const sidebarLinks = computed(() => {
    const links = [
        ...
        { name: 'Facturation', icon: 'bi-receipt', route: '/company/invoices', key: 'company-invoices' },
    ...
    if (authStore.user?.is_company_admin) {
        links.splice(3, 0, { name: 'Utilisateurs', icon: 'bi-people', route: '/company/users', key: 'company-users' });
    }
