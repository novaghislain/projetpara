...
const fetchData = async () => {
    ...
    try {
        ...
        const accRes = await fetch('/api/accounting/accounts/' + props.clientId);
        ...
        const res = await fetch('/api/accounting/reports/grand-livre/' + props.clientId + '?' + params.toString());
