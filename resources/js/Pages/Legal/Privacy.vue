...
<template>
  <div class="min-h-screen bg-gray-100 py-12 px-4">
    <div class="max-w-3xl mx-auto bg-white rounded-xl shadow-lg p-8 animate-slide-up">
      <h1 class="text-3xl font-bold text-gray-900 mb-6 animate-fade-in">Politique de confidentialité</h1>
      ...
      <div class="prose max-w-none">
        ...
        <ul>
          ...
          <li>Informations entreprise : nom, adresse, numéro fiscal</li>
          <li>Données comptables : écritures, factures, transactions bancaires</li>
        ...
        <ul>
          <li>Fournir le service de comptabilité en ligne</li>
          <li>Générer vos états financiers et rapports</li>
        ...
        <ul>
          ...
          <li>Stockage sécurisé des mots de passe (hashés)</li>
          <li>Isolation multi-tenant stricte (chaque entreprise ne voit que ses données)</li>
