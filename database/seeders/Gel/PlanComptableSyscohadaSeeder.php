...
class PlanComptableSyscohadaSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $comptes = [
            ...
            ['code' => '443', 'intitule' => 'État, TVA facturée', 'classe' => '4', 'type' => 'passif', 'niveau' => 2, 'code_parent' => '44', 'syscohada' => true],
            ['code' => '444', 'intitule' => 'État, TVA due ou crédit de TVA', 'classe' => '4', 'type' => 'passif', 'niveau' => 2, 'code_parent' => '44', 'syscohada' => true],
            ['code' => '445', 'intitule' => 'État, TVA récupérable', 'classe' => '4', 'type' => 'actif', 'niveau' => 2, 'code_parent' => '44', 'syscohada' => true],
